  ...
  return (
    <div className={`bg-white rounded-xl border border-gray-200 shadow-sm ${className}`}>
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        {/* Mobile unified media buttons */}
        {!mediaPreview && (
          <div className="md:hidden space-y-3">
            <p className="text-sm font-medium text-gray-700">Add media:</p>
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                onClick={triggerCamera}
                disabled={uploading}
                className="bg-blue-600 text-white py-3 px-3 rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50 flex flex-col items-center justify-center gap-1 text-xs"
              >
              ...
              <button
                ...
                disabled={uploading}
                className="bg-purple-600 text-white py-3 px-3 rounded-lg font-medium hover:bg-purple-700 disabled:opacity-50 flex flex-col items-center justify-center gap-1 text-xs"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                onClick={triggerFileSelect}
                disabled={uploading}
                className="bg-gray-600 text-white py-3 px-3 rounded-lg font-medium hover:bg-gray-700 disabled:opacity-50 flex flex-col items-center justify-center gap-1 text-xs"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
